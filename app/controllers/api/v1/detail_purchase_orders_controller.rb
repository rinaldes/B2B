module Api
  module V1
    class DetailPurchaseOrdersController < ApplicationController
      require "net/http"
      require "uri"
      skip_before_filter :authenticate_user!
      #sementara di deklarasikan sini dulu
      def callback_podetails
        request_api = "#{api_call('api')}/poline"
        ...
        if DetailsPurchaseOrder.save_detail_po_from_api(result)
